 ...
 * Changes: next/image → plain <img>, removed Image sizing tricks.
 * Scroll-hijacking kept as the signature behavior — heads-up this is
 * aggressive UX. Fine for a preview to evaluate.
 */
