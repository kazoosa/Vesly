...
/**
 * Adapted from nextlevelbuilder pattern. No Next-specific imports.
 * Scope kept intentionally: h-[600px] instead of h-screen, so it lives
 * inside a landing section instead of taking the whole viewport.
 */
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        <div ref={orbitRef} className="absolute w-full h-full flex items-center justify-center" style={{ perspective: "1000px" }}>
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 via-sky-500 to-emerald-400 animate-pulse flex items-center justify-center z-10">
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl text-white">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-sky-500 to-indigo-500" style={{ width: `${item.energy}%` }} />
                        </div>
                      </div>
